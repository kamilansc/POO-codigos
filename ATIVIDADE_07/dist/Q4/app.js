...
const Q4_banco_1 = __importDefault(require("./Q4_banco"));
...
class App {
    ...
    constructor() {
        this.banco = new Q4_banco_1.default();
    ...
    inserirConta() {
        ...
        let conta;
        if (tipo == '2') {
            conta = new Q4_contaPoupanca_1.default(numero, saldo, 2);
        }
        else if (tipo = '3') {
            conta = new Q4_contaImposto_1.default(numero, saldo, 1);
        }
        else {
            conta = new Q4_conta_1.default(numero, saldo);
        }
    ...
    inserirCliente() {
        ...
        let cliente = new Q4_cliente_1.default(nome, cpf, dataNascimento);
